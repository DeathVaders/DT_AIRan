...
%% 定义五组固定参数
manual_sets(1).AoA_az = [-40, 0];
manual_sets(1).AoA_el = [60, 42];
manual_sets(1).ToA = [50e-9, 160e-9];
manual_sets(1).alpha = [
    1.00 * exp(1j * 0.20 * pi), ...
    0.72 * exp(1j * 0.75 * pi)
];

manual_sets(2).AoA_az = [-55, -12];
manual_sets(2).AoA_el = [68, 45];
manual_sets(2).ToA = [70e-9, 180e-9];
manual_sets(2).alpha = [
    1.00 * exp(1j * 0.30 * pi), ...
    0.70 * exp(1j * 0.95 * pi)
];

manual_sets(3).AoA_az = [-25, 18];
manual_sets(3).AoA_el = [58, 38];
manual_sets(3).ToA = [40e-9, 140e-9];
manual_sets(3).alpha = [
    1.00 * exp(1j * 0.15 * pi), ...
    0.68 * exp(1j * 0.85 * pi)
];

manual_sets(4).AoA_az = [-62, -20];
manual_sets(4).AoA_el = [72, 50];
manual_sets(4).ToA = [90e-9, 210e-9];
manual_sets(4).alpha = [
    1.00 * exp(1j * 0.25 * pi), ...
    0.74 * exp(1j * 0.90 * pi)
];

manual_sets(5).AoA_az = [-35, 10];
manual_sets(5).AoA_el = [66, 44];
manual_sets(5).ToA = [60e-9, 190e-9];
manual_sets(5).alpha = [
    1.00 * exp(1j * 0.18 * pi), ...
    0.71 * exp(1j * 1.00 * pi)
];
